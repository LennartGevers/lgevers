...
>
      <nav className="w-full px-12 flex justify-between items-center py-6 bg-opacity-80 backdrop-blur-md rounded-lg shadow-lg animate-fade-in">
...
<footer className="bg-[var(--background)] text-[#c9c9c9] border-t border-[#282c34]">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">.getFullYear()
